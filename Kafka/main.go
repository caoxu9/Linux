...
type AutoGenerated struct {
	...
	Metadata  struct {
		Beat    json.RawMessage `json:"beat"`
	...
	Fields struct {
		LogTopic json.RawMessage `json:"log_topic"`
	} `json:"fields"`
	Ecs struct {
		Version json.RawMessage `json:"version"`
	} `json:"ecs"`
	Host struct {
		...
		Os           struct {
			Codename json.RawMessage `json:"codename"`
	...
	Agent struct {
		Type        json.RawMessage `json:"type"`
		EphemeralID json.RawMessage `json:"ephemeral_id"`
		Hostname    json.RawMessage `json:"hostname"`
		ID          json.RawMessage `json:"id"`
		Version     json.RawMessage `json:"version"`
	} `json:"agent"`
